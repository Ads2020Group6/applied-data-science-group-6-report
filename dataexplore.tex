...
\paragraph{Companies grouped by Industrial Sector}
    The number of countries in each industrial sector (at top-level granularity) are shown in Figure\ \ref{fig:companies-by-sector}. The majority of the data arises from Education, Manufacturing, Wholesale and retail trade, and Admistrative and support services.
